...
class FPDF
{
	...
	//Estas funciones son propias del fpdf (Encontrado Joel Vasquez Lingan)
	function Footer()
	{
		// To be implemented in your own inherited class
		...
		$this->Image('./public/dist/img/piepagina.jpg', 0, null, null, null);
		$this->Cell(0, 5, utf8_decode('pagina ' . $this->PageNo()), 0, 0, 'R');
	}
...
class PDF extends FPDF
{
	...
	{
		//Logo
		$this->Image('./public/dist/img/Firma.png', 10, 8, 33);
		//Arial bold 15
