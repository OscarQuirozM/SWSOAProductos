$(function () {
  ...
  $('#btnagregar').on('click', function () {
    ...
    $.ajax({
      type: 'POST',
      url: '/portalcliente/usuario/Consultar_Usuario',
      data: {
        v_dni: v_dni
      },
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        if (res.estado == 1) {
          ...
          $.ajax({
            type: 'POST',
            url: '/portalcliente/usuario/Consultar_Persona',
            data: {
              v_dni: v_dni
            },
            success: function (res) {
  ...
  $('#xbtnguardar').on('click', function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: 'POST',
          url: '/portalcliente/usuario/registro_usuario',
          data: {
            post: post,
            v_dni: v_dni,
            v_nombres: v_nombres,
...
function navegacionmenu(string) {
  $.ajax({
    type: "POST",
    url: "/portalcliente/dashboard/cambiarsession",
    data: { string: string },
  });
  var dato = ""; //cerrado
  $.ajax({
    type: "POST",
    url: "/portalcliente/dashboard/cambiaropen",
    data: { string: dato },
  });
}
...
function clicksub(string) {
  $.ajax({
    type: "POST",
    url: "/portalcliente/dashboard/cambiarsessionsub",
    data: { string: string },
  });
